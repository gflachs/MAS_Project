...
public class OrderLineItemService {
    ...
    public OrderLineItemService(OrderLineItemRepository orderLineItemRepository, ItemStatusRepository itemStatusRepository, OrderService orderService, ArticleService articleService) {
    ...
    public Set<OrderLineItem> getOrderLineItemsByStatus (ItemStatus itemStatus) {
        ...
        return orderLineItemEntities.stream().map(orderLineItemEntitie -> entityToOrderLineItem(orderLineItemEntitie)).collect(Collectors.toSet());
    }

    public static OrderLineItem entityToOrderLineItem (OrderLineItemEntity entity) {
        return new OrderLineItem(entity.getItemID(), entity.getArticle().getArticleId(), entity.getAmount(), entity.getPrice(),entity.getOrderEntity().getId(),new ItemStatus(entity.getItemStatus().getItemStatus()));
    }
    ...
    public static OrderLineItemEntity bodyToEntity (OrderLineItemBody body, OrderService orderService, ArticleService articleService) {
        ...
        return new OrderLineItemEntity(articleEntity, body.getAmount(), body.getPrice(), orderEntity, new ItemStatusEntity(body.getItemStatus().getItemStatus()));
    }
